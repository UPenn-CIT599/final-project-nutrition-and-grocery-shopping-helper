...
/* 
 * This is a classifier for predicitng dogs and cats as an initial simple test to ensure the pretrained
 * transfer model and logic are working properly. This code will be refactored to predict grocery items at a 
 * later date
 * 
 */
...
public class TrainImageNetVG16 {
    ...
    public static final Random RAND_NUM_GEN = new Random(seed); //Generate some random number 
    ...
    private static final int NUM_POSSIBLE_LABELS = 2; //Number of items that the model can predict 
    ...
    // Training data for dogs and cats classifier is here
    ...
    public static void main(String[] args) throws IOException {
    	...
    	// Let's import our zoo model 
    	ZooModel zooModel = new VGG16();
    	LOGGER.info("Start Downloading VGG16 model...");
        
    	
    	//We also load a pre-trained VGG-16 model initialized with weights trained on ImageNet
        ...
        File trainData = new File(TRAIN_FOLDER); // Training data
        File testData = new File(TEST_FOLDER); //Testing data 
        ...
        //We set up a fine configuration to fine the learning configurations of an existing model of our pre-trained VGG16 model
        ...
        /*
         * We are going to build new models based on VGG16 by modifying on the last layer and keeping others frozen.
         * In the original model, a softmax regression is done on the 1000 classes in ImageNet. We modify the last layer
         * to give predictions for five classes while keeping those other layers frozen. 
         */
